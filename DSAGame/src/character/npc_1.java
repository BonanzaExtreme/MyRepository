...
public class npc_1 extends entityImage {
	...
	public void getNPC1Image() {
			...
			UP1 = setup("/NPCpicture/Character_UP1");
			UP2 = setup("/NPCpicture/Character_UP2");
			DOWN1 = setup("/NPCpicture/Character_down1");
			DOWN2 = setup("/NPCpicture/Character_down2");
			RIGHT1= setup("/NPCpicture/Character_RIGHT1");
			RIGHT2 = setup("/NPCpicture/Character_RIGHT2");
			LEFT1 = setup("/NPCpicture/Character_LEFT1");
			LEFT2 = setup("/NPCpicture/Character_LEFT2");
			STATIC = setup("/NPCpicture/Character");
		}
